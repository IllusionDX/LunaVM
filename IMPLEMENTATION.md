...
| `0.1.11-alpha` | **Current** | Fixed VM register auto-release: `SET_REG_PRIM` skips retain for primitives, `SET_REG` retains/releases objects. Integer fast-path in `OP_ADD`. All constructors use refcount=0 (floating ARC). |
