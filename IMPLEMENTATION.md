...
| `0.4.2-alpha` | **Current** | Leaf call fast path — skip PUSH_FRAME/RET for methods that make no calls, have no upvalues, no defaults, no try/catch. Saves ~20% on entity update benchmark (0.117s → 0.094s). |
